...
class WxPayDataBase
{
     ...
     * @param string $value
     **/
    public function mch_appid($value)
    {
     ...
     * @param string $value
     **/
    public function mchMch_id($value)
    {
     ...
     * @param string $value
     **/
    public function partner_trade_no($value)
    {
    ...
    /**
     * 设置订单生成时间
     * 格式为yyyyMMddHHmmss，如2009年12月25日9点10分10秒表示为20091225091010。详见时间规则
     *
     * @param string $value
     **/
    ...
    /**
     * 获取订单生成时间
     * 格式为yyyyMMddHHmmss，如2009年12月25日9点10分10秒表示为20091225091010。详见时间规则的值
     *
     * @return 值
     **/
    ...
    /**
     * 判断订单生成时间
     * 格式为yyyyMMddHHmmss，如2009年12月25日9点10分10秒表示为20091225091010。详见时间规则是否存在
     *
     * @return true 或 false
     **/
    ...
    /**
     * 设置订单失效时间
     * 格式为yyyyMMddHHmmss，如2009年12月27日9点10分10秒表示为20091227091010。详见时间规则
     *
     * @param string $value
     **/
    ...
    /**
     * 获取订单失效时间
     * 格式为yyyyMMddHHmmss，如2009年12月27日9点10分10秒表示为20091227091010。详见时间规则的值
     *
     * @return 值
     **/
    ...
    /**
     * 判断订单失效时间
     * 格式为yyyyMMddHHmmss，如2009年12月27日9点10分10秒表示为20091227091010。详见时间规则是否存在
     *
     * @return true 或 false
     **/
    ...
    /**
     * 获取系统时间
     * 格式为yyyyMMddHHmmss，如2009年12月27日9点10分10秒表示为20091227091010。其他详见时间规则的值
     *
     * @return 值
     **/
    ...
    /**
     * 判断系统时间
     * 格式为yyyyMMddHHmmss，如2009年12月27日9点10分10秒表示为20091227091010。其他详见时间规则是否存在
     *
     * @return true 或 false
     **/
    ...
    /**
     * 获取交易类型的值
     * 取值如下：JSAPI，NATIVE，APP，详细说明见参数规定的值
     *
     * @return 值
     **/
    ...
    /**
     * 判断交易类型是否存在
     * 取值如下：JSAPI，NATIVE，APP，详细说明见参数规定是否存在
     *
     * @return true 或 false
     **/
